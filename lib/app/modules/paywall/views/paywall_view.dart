          ...
          child: Column(
            children: [
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.close_rounded,color: Colors.grey.shade900,),
                      ),
                    ),
              ...
              decoration: BoxDecoration(
                ...
                child: Text("Unlock Unlimited Access",style: TextStyle(
...
verticalSpace(SizeConfig.blockSizeVertical * 1),
              feature_description(Colors.deepPurple, AppImages.compareAndAlternate, "Compare products or find alternatives."),
              feature_description(Colors.deepOrange, AppImages.noAds, "Ad-free experience."),
              feature_description(Colors.pink, AppImages.upgradeApple, "Earn additional rewards."),
              Padding(
              ...
              Container(
                ...
                child: Text("Track your daily calorie intake easily with our Calories Finder app! Get personalized insights and stay on top of your health goals. 💪🍏",style: TextStyle(
  ...
  Padding feature_description(Color bgClr, String image, String desc,) {
    return Padding(
            ...
            if (package.identifier == '\$rc_weekly')
              Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:  EdgeInsets.only(left: SizeConfig.blockSizeHorizontal * 15,top: SizeConfig.blockSizeVertical * 1.1),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text(
