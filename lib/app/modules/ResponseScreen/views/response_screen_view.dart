                      ...
                      children: [
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(
                                          Icons.star,
                                          color:
                                              foodData.value!.item.healthScore >
                                                      0
                                                  ? Colors.amber
                                                  : Colors.black26,
                                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                    foodData.value!.item.totalCalories
                                        .toString(),
                                    style: GoogleFonts.openSans(
                                      textStyle: TextStyle(
                                          // height: 1,
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text('${foodData.value!.item.fat} g',
                                              // '$fatW g',
                                              style: GoogleFonts.openSans(
                                                textStyle: TextStyle(
                                                  fontSize: SizeConfig
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          SizedBox(),
                                          Text(
                                              '${foodData.value!.item.percentageCaloriesFromCarbs} %',
                                              // '$carbsp %',
                                              style: GoogleFonts.openSans(
                                                textStyle: TextStyle(
                                                  fontSize: SizeConfig
                                          ...
                                          Text(
                                              '${foodData.value!.item.percentageCaloriesFromProtein} %',
                                              // '$protienp %',
                                              style: GoogleFonts.openSans(
                                                textStyle: TextStyle(
                                                  fontSize: SizeConfig
                                          ...
                                          Text(
                                              '${foodData.value!.item.percentageCaloriesFromFat} %',
                                              // '$fatp %',
                                              style: GoogleFonts.openSans(
                                                textStyle: TextStyle(
                                                  fontSize: SizeConfig
                                      ...
                                      children: [
                                        ...
                                        Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                  // '  $waterQ',
                                                  '  Drink ${foodData.value!.item.waterQuantity} ltr(s) of water',
                                                  style: GoogleFonts.roboto(
                                                    textStyle: TextStyle(
                                                        color: Colors.black),
                                                  )
                                        ...
                                        Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                  // '  $exerciseQ',
                                                  '  Exercise for ${foodData.value!.item.exercise} hour(s)',
                                                  style: GoogleFonts.roboto(
                                                    textStyle: TextStyle(
                                                        color: Colors.black),
                                                  )
                        ...
                        Center(
                          child: AppThemeButton(
                                  onPressed: () {
                                    controller.logFeed(foodData.value!);
                                  },
                                  text: 'Log Food')
                              .largeButton(),
                        ),
